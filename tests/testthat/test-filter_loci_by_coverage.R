...
test_that('correct set to 0 check', {
    ...
    expect_equal(bs_cov[1,'test1'], 0, ignore_attr = TRUE)
    expect_equal(bs_cov[2,'test1'], 0, ignore_attr = TRUE)
    expect_equal(bs_cov[7,'test2'], 0, ignore_attr = TRUE)
    expect_equal(bs_cov[8,'test2'], 0, ignore_attr = TRUE)
    expect_equal(bs_cov[10,'test1'], 0, ignore_attr = TRUE)
    expect_equal(bs_cov[11,'test1'], 0, ignore_attr = TRUE)

    expect_equal(bs_meth[1,'test1'], 0, ignore_attr = TRUE)
    expect_equal(bs_meth[2,'test1'], 0, ignore_attr = TRUE)
    expect_equal(bs_meth[7,'test2'], 0, ignore_attr = TRUE)
    expect_equal(bs_meth[8,'test2'], 0, ignore_attr = TRUE)
    expect_equal(bs_meth[10,'test1'], 0, ignore_attr = TRUE)
    expect_equal(bs_meth[11,'test1'], 0, ignore_attr = TRUE)
})
