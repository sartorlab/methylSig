...
The following example illustrates a case with no covariates and where the model has no intercept. Note, the change in contrast.
...
The following example illustrates a case with covariates and where the model has no intercept. Note, the change in contrast.
