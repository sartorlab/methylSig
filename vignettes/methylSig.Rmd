...
author: "Yongseok Park, Raymond Cavalcante, Maria E. Figueroa, Laura S. Rozek, and Maureen A. Sartor"
date: "`r Sys.Date()`"
output:
  pdf_document:
    toc: true
...
Again, there are two functions, \verb@refGeneAnnotation()@ and \verb@refGeneAnnotationPlot()@, in `methylSig` package for annotation using RefGene models. The refGene information file can be download from websites such UCSC genome browser. The appropriate genome assembly (the same genome assembly of the provided data) should be used.
